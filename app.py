        ...
        if return_code == 0:
            ...
            if os.path.exists(converted_path):
                ...
                if output_size >= input_size:
                    ...
                    print(f"WARNING: File may already be optimized or FFmpeg failed")
                    # Just use the output as-is, don't try complex fallbacks
                    compression_ratio = 0.0
                    print(f"DEBUG: Using original file size - no compression achieved")
                else:
                    compression_ratio = ((input_size - output_size) / input_size) * 100
                    print(f"DEBUG: Compression successful: {compression_ratio:.2f}% reduction")
